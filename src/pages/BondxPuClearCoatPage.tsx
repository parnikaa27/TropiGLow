  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-emerald-50 via-teal-50 to-cyan-50">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <div className="flex items-center space-x-3 mb-4">
                <Paintbrush className="h-8 w-8 text-300" />
      ...
      <div className="max-w-7xl mx-auto px-4 py-16 space-y-16">
        {/* Features */}
        <section>
          <h2 className="text-3xl font-bold text-slate-800 mb-8 text-center">Features & Benefits</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              <div key={idx} className="bg-white rounded-xl p-6 shadow-lg border border-slate-200 hover:shadow-xl transition-all duration-300">
        ...
        <section className="bg-white rounded-xl p-8 shadow-lg border border-emerald-200 text-center">
          ...
          <button
            ...
            className="bg-white text-teal-600 px-8 py-3 rounded-md font-semibold hover:bg-gray-100 transition"
          >
            Request a Sample
          </button>
        </section>
