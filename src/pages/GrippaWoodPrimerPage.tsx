...
const GrippaWoodPrimerPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-emerald-50 via-teal-50 to-cyan-50">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <div className="flex items-center space-x-3 mb-4">
                ...
                <h1 className="text-5xl font-bold">GRIPPA 2K WOOD PRIMER</h1>
              </div>
              <p className="text-emerald-200 text-xl mb-6">Two-Component Primer for Wood Surfaces</p>
              <p className="text-lg leading-relaxed mb-8">
                GRIPPA 2K Wood Primer is a two-component primer engineered specifically for wood substrates. It seals
                the grain and provides excellent sanding properties, creating a smooth, uniform base for wood finishes
                and topcoats. The result is a professional foundation that enhances the durability and appearance of
                every wood coating system.
              </p>

              <div className="flex flex-wrap gap-4">
                <div className="flex items-center space-x-2 bg-white bg-opacity-20 rounded-lg px-4 py-2">
                  <Shield className="h-5 w-5 text-blue-300" />
                  <span>Grain Sealing</span>
                </div>
                <div className="flex items-center space-x-2 bg-white bg-opacity-20 rounded-lg px-4 py-2">
                  <Droplets className="h-5 w-5 text-emerald-300" />
                  <span>Excellent Sandability</span>
                </div>
                <div className="flex items-center space-x-2 bg-white bg-opacity-20 rounded-lg px-4 py-2">
                  <Star className="h-5 w-5 text-cyan-300" />
                  <span>Uniform Base</span>
                </div>
              </div>
            </div>
            ...
            <div className="relative">
              <img
                ...
                alt="GRIPPA 2K Wood Primer Application"
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        {/* Primer Features */}
        <div className="mb-16">
          <h2 className="text-3xl font-bold text-slate-800 mb-8 text-center">2K Wood Primer Features</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              {
                icon: Droplets,
                title: "Grain Sealing",
                description: "Penetrates and seals wood grain to prevent uneven absorption of topcoats."
              },
              {
                icon: Eye,
                title: "Excellent Sandability",
                description: "Sands down easily to a smooth surface, ready for a flawless finish."
              },
              {
                icon: Layers,
                title: "Two-Component System",
                description: "Reactive 2K formulation cures to a hard, durable primer film on wood."
              },
              {
                icon: Star,
                title: "Uniform Base",
                description: "Creates a consistent, even foundation for uniform color and topcoat appearance."
              },
              {
                icon: Shield,
                title: "Strong Adhesion",
                description: "Bonds firmly to wood substrates ensuring long-lasting finish performance."
              },
              {
                icon: Zap,
                title: "Quick Drying",
                description: "Fast-drying formula allows for efficient sanding and quick recoating."
              }
            ].map((feature, index) => (
        ...
        <div className="bg-white rounded-xl p-8 shadow-lg border border-emerald-200 text-center">
          <h3 className="text-2xl font-bold text-slate-800 mb-4">Smooth, Professional Wood Finishing</h3>
          <p className="text-slate-700 mb-6 text-lg max-w-2xl mx-auto">
            Create the perfect base for wood finishes with GRIPPA 2K Wood Primer. Get expert advice on wood surface
            preparation, sanding techniques, and topcoat compatibility for optimal performance.
          </p>
...
export default GrippaWoodPrimerPage;