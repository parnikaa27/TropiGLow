  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-emerald-50 via-teal-50 to-cyan-50">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-emerald-200 text-xl mb-6">Advanced Marine Antifouling Protection</p>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="mb-16">
          <h2 className="text-3xl font-bold text-cyan-800 mb-8 text-center">Advanced Antifouling Features</h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-16">
          ...
          <div className="bg-white rounded-xl p-8 shadow-lg border border-cyan-200">
            <h3 className="text-xl font-bold text-cyan-800 mb-6">Marine Benefits</h3>
            <div className="space-y-4">
              {[
        ...
        <div className="bg-white rounded-xl p-8 shadow-lg border border-emerald-200 text-center">
          <h3 className="text-2xl font-bold text-cyan-800 mb-4">Professional Marine Antifouling Solutions</h3>
