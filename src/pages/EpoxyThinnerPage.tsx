...
const EpoxyThinnerPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-emerald-50 via-teal-50 to-cyan-50">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <div className="flex items-center space-x-3 mb-4">
                ...
                <h1 className="text-5xl font-bold">EPOXY THINNER</h1>
              </div>
              <p className="text-emerald-200 text-xl mb-6">Solvent Thinner for Epoxy Coatings</p>
              <p className="text-lg leading-relaxed mb-8">
                EPOXY Thinner is a specially formulated solvent blend for thinning and adjusting the viscosity of
                two-component epoxy primers and coatings. It optimizes application by brush, roller, or spray, ensuring
                smooth, even coverage. It is also ideal for cleaning equipment and tools after use.
              </p>

              <div className="flex flex-wrap gap-4">
                <div className="flex items-center space-x-2 bg-white bg-opacity-20 rounded-lg px-4 py-2">
                  <Shield className="h-5 w-5 text-blue-300" />
                  <span>Optimized Viscosity</span>
                </div>
                <div className="flex items-center space-x-2 bg-white bg-opacity-20 rounded-lg px-4 py-2">
                  <Droplets className="h-5 w-5 text-emerald-300" />
                  <span>Improved Flow</span>
                </div>
                <div className="flex items-center space-x-2 bg-white bg-opacity-20 rounded-lg px-4 py-2">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        {/* Thinner Features */}
        <div className="mb-16">
          <h2 className="text-3xl font-bold text-slate-800 mb-8 text-center">Epoxy Thinner Features</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              {
                icon: Shield,
                title: "Optimized Viscosity Control",
                description: "Precisely adjusts the viscosity of epoxy coatings for smooth, controlled application."
              },
              {
                icon: Droplets,
                title: "Formulated for Epoxy Systems",
                description: "Specially blended to be fully compatible with two-component epoxy primers and coatings."
              },
              {
                icon: Star,
                title: "Improves Flow &amp; Leveling",
                description: "Enhances flow and leveling for a uniform, professional finish free from imperfections."
              },
              {
                icon: Zap,
                title: "Ideal for Spray Application",
                description: "Achieves the correct spray viscosity for consistent atomization and even coverage."
              },
              {
                icon: Eye,
                title: "Effective Equipment Cleaning",
                description: "Efficiently cleans brushes, rollers, and spray equipment immediately after use."
              },
              {
                icon: Clock,
                title: "Consistent Quality",
                description: "Manufactured to strict standards ensuring reliable performance batch after batch."
              }
            ].map((feature, index) => (
        ...
        <div className="bg-white rounded-xl p-8 shadow-lg border border-emerald-200 text-center">
          <h3 className="text-2xl font-bold text-slate-800 mb-4">Perfect Viscosity for Epoxy Coatings</h3>
          <p className="text-slate-700 mb-6 text-lg max-w-2xl mx-auto">
            Ensure professional results with EPOXY Thinner. Get expert advice on thinning ratios,
...
export default EpoxyThinnerPage;
