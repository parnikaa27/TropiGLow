  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-emerald-50 via-teal-50 to-cyan-50">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <div className="flex items-center space-x-3 mb-4">
                ...
                <h1 className="text-5xl font-bold">PU THINNER</h1>
              </div>
              <p className="text-emerald-200 text-xl mb-6">Solvent Thinner for PU Coatings</p>
              <p className="text-lg leading-relaxed mb-8">
                PU Thinner is a high-grade solvent blend for thinning polyurethane (PU) topcoats and clear coats. It
                ensures smooth flow, correct spray viscosity, and a flawless finish on every application. It is also
                suitable for cleaning tools and equipment after use.
              </p>
              ...
              <div className="flex flex-wrap gap-4">
                ...
                <div className="flex items-center space-x-2 bg-white bg-opacity-20 rounded-lg px-4 py-2">
                  ...
                  <span>Spray-Ready Viscosity</span>
                </div>
                <div className="flex items-center space-x-2 bg-white bg-opacity-20 rounded-lg px-4 py-2">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        {/* Thinner Features */}
        <div className="mb-16">
          <h2 className="text-3xl font-bold text-slate-800 mb-8 text-center">PU Thinner Features</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              {
                icon: Shield,
                title: "Formulated for PU Coatings",
                description: "Specially blended for full compatibility with polyurethane topcoats and clear coats."
              },
              {
                icon: Droplets,
                title: "Smooth Flow &amp; Leveling",
                description: "Promotes even flow and leveling for a uniform, mirror-smooth surface."
              },
              {
                icon: Zap,
                title: "Spray-Ready Viscosity",
                description: "Achieves the correct spray viscosity for consistent atomization and fine finishes."
              },
              {
                icon: Clock,
                title: "Fast Evaporation",
                description: "Balanced evaporation rate helps prevent runs, sags, and slow drying."
              },
              {
                icon: Star,
                title: "Streak-Free Finish",
                description: "Delivers a flawless, streak-free appearance free from blush and imperfections."
              },
              {
                icon: Eye,
        ...
        <div className="bg-white rounded-xl p-8 shadow-lg border border-emerald-200 text-center">
          <h3 className="text-2xl font-bold text-slate-800 mb-4">Flawless Finishes for PU Coatings</h3>
          <p className="text-slate-700 mb-6 text-lg max-w-2xl mx-auto">
            Ensure professional results with PU Thinner. Get expert advice on thinning ratios,
