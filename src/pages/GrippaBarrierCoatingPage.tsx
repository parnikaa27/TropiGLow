...
const GrippaBarrierCoatingPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-red-50 via-orange-50 to-yellow-50">
      {/* Hero Section */}
      <div className="bg-gradient-to-r from-red-800 via-orange-800 to-yellow-800 text-white py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <button
            onClick={() => navigate('/')}
            className="flex items-center space-x-2 text-red-200 hover:text-white mb-6 transition-colors duration-200"
          >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-red-200 text-xl mb-6">Advanced Moisture & Alkali Barrier System</p>
